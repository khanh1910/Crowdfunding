...
document.getElementById("add_money").onclick = function(){
	document.getElementById("box_addmoney").style.opacity = "100%";
	document.getElementById("box_addmoney").style.pointerEvents = "all";
}

document.getElementById("close_boxaddmoney").onclick = function(){
